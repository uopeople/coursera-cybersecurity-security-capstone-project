...
<div>
    <section class="section">
        ...
        <h3 class="has-text-centered is-size-3">

            <!-- include  from icon font
            <span class="icon">
            ...
            <span>
            &nbsp;Coursera Capstone Project Messaging System
            </span>
        </h3>
    </section>
    ...
    <section class="section">
        <div class="content has-text-centered">
            <a href="<?= AppInfo::urlLoginPage() ?>" class="button">Login</a>
            <a href="<?= AppInfo::urlRegisterPage() ?>" class="button">Register</a>
        </div>
    </section>
</div>
