    ...
    <section class="section">
        ...
        switch (htmlspecialchars($_GET['message'])) {
            ...
            case "login_required":
                ...
                break;
            case "account-locked":
                echo Alertbox::renderError('Your Account has been locked, because of too many failed login attempts. Please wait 2 minute');
                break;
    ...
    <form method="post">
        ...
        <div class="field">
            ...
            <div class="control has-icons-left">
                <input class="input" type="text" name="username" id="field-username" required placeholder="Username"/>
